...
async function scrapeCourses() {
  ...
  try {
    ...
    // Process courses
    const allCourses = await processSearchResults(page, existingCourses, browser);
...
async function processSearchResults(page, existingCourses, browser) {
  ...
  // We're already on the search form
  ...
  // Select "基盤科目" from the 分野 dropdown using the correct selector
  console.log('Selecting "基盤科目" from 分野 dropdown...');
