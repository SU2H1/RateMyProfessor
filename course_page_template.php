    ...
    <div class="container" style="width: 100%; min-height: 100vh; display: flex; flex-direction: column; max-width: 1200px; margin: 0 auto; padding: 2rem;">
        ...
        <div class="professor-info" style="margin-bottom: 30px;">
            ...
            <div class="professors">
                ...
                <div class="professor-card" onclick="window.location.href='professor_page_template.php?professor=<?php echo urlencode(str_replace(' ', '', $professor['name']['en'])); ?>&lang=<?php echo $lang; ?>'">
                                ...
                                if (data.professors.length > 0) {
                                    ...
                                    data.professors.forEach(prof => {
                                        ...
                                        item.addEventListener('click', () => {
                                            ...
                                            window.location.href = `professor_page_template.php?professor=${encodeURIComponent(nameForUrl)}&lang=<?php echo $lang; ?>`;
