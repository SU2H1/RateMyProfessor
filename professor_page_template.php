    ...
    <div class="container">
        ...
        <div class="rating-overview" style="display: flex; flex-wrap: wrap; gap: 30px; margin-bottom: 30px;">
            ...
            <div class="rating-details" style="flex-grow: 1; min-width: 300px;">
                ...
                <div class="rating-category" style="display: flex; align-items: center; margin-bottom: 15px; position: relative;">
                    <div class="category-name" style="width: 140px; font-size: 0.95em; color: #444; flex-shrink: 0;">
                        <?php echo $category['label']; ?>
                        <div style="font-size: 0.8em; color: #666;">
                            <?php echo $category['description']; ?>
                        </div>
                    </div>
                    <div class="progress-bar" style="flex-grow: 1; height: 8px; background-color: #e9ecef; border-radius: 4px; margin: 0 30px 0 15px; overflow: hidden;">
                        <div class="progress" style="width: <?php echo $category['percent']; ?>%; height: 100%; background-color: <?php echo $category['color'] ?? '#1e3a8a'; ?>;"></div>
                    </div>
                    <div class="category-score" style="min-width: 40px; text-align: right; font-weight: bold; color: #1e3a8a; flex-shrink: 0; position: absolute; right: 0;">
